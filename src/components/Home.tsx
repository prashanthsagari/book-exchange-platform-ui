    ...
    return (
        <>
            <div className='container-fluid'>
                <div className='row'>
                    <h3 className='text-center alert alert-primary m-5 mx-auto'>
                        Book Exchange Platform
                    </h3>
                    <h4 className='m-5 mx-auto  p-4 text-center border border-warning-subtle  font-monospace'>
                        Book lovers frequently accumulate a collection of books they have read and look for other
                        recommendations. <br /> They are always eager to explore new reading material. Traditional methods of
                        exchanging books, such as local book swaps or lending among friends, are limited in scope and
                        accessibility. <br /> Therefore, it is imperative to have a digital platform that can facilitate book exchanges on a
                        larger scale. 
                        <br />
                        This platform should connect users with similar reading interests, enabling them to trade
